...
elseif ($exists == TRUE && $_SERVER['REQUEST_METHOD'] == "GET") {
    // GPTMS/api/course-management/courses/1/holeSelect
    if ($document == "course-management" && $collection == "courses" && $collectionURI != NULL && $controller == NULL && $filter == NULL && $filterVal == NULL && $store == "holeSelect" && $storeURI == NULL) {
        $function = "holeSelect";
    }
    else {
        $function = "error";
