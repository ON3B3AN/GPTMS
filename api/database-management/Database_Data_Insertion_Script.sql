...
(1, 18, 5, 5, '01:30:00', 4, 4, 'The longest par 5 on the course plays even longer than its yardage because it is uphill. Two long and straight wood shots are needed to get into position for a medium to short iron third shot. Play to the right-center of the fairway on the second shot to avoid the deep ravine in the left rough. The elevated green slopes away from the fairway, so allow for more roll than normal on the approach shot after it lands on the green.', ),
(2, 1, 4, 4, '00:05:00', 7, 3, 'Golfers may aggressively play their tee shot over the short left fairway bunker to shorten this long par 4 opening hole. The green has a small section in the middle that will draw overly aggressive shots into the chipping area behind the green.', NULL),
(2, 2, 4, 4, '00:10:00', 13, 13, 'The player is challenged from the tee to hit a straight shot between the two majestic oaks framing the landing area. The green slopes away from the line of play and is surrounded on three sides by tight fairway grass and a steep rough area on the fourth.', NULL),
(2, 3, 3, 3, '00:15:00', 15, 15, 'Playing downhill and framed by native grass, club selection is crucial on this par 3. The large green is deep enough to accommodate the mid- to long-iron shot. Failing to hit this green, the best chance to score is to hit it straight and leave your ball in the deceptively large approach.', NULL),
(2, 4, 4, 4, '00:20:00', 3, 9, 'A well-placed tee shot will land left and long of the short right-hand fairway bunker. This will position your ball at the best angle into one of the smaller greens on the course. This hole plays considerably more uphill than it appears.', NULL),
(2, 5, 4, 4, '00:25:00', 9, 7, 'Tee shots up the right side of the fairway will propel the ball ahead and feed it into the center of this wide landing area. The key to scoring well on this hole is to place your approach shot on the same level as the pin location.', NULL),
(2, 6, 5, 5, '00:30:00', 1, 1, 'Careful planning and proper execution are crucial to scoring on this dramatic hole.', NULL),
(2, 7, 3, 3, '00:35:00', 17, 17, 'The tee shot plays uphill into a crowned green. A creative short game is a must on this hole. Leave yourself on the low side of the pin placement to score well.', NULL),
(2, 8, 4, 4, '00:40:00', 11, 11, 'This par 4 is best played over the far left edge of the right fairway bunker. Run your approach shot in from left to right, allowing the ground to feed the shot to the hole.', NULL),
(2, 9, 5, 5, '00:45:00', 5, 5, 'Playing uphill the entire way, this par 5 is a true three-shot hole. From the tee, take aim at the center of the three bunkers defining the play area. The challenge on this hole is trusting your yardage, selecting the right club and positioning your ball around the small slick green.', NULL),
(2, 10, 5, 5, '00:50:00', 4, 4, 'Playing downhill, the tee shot will get extra kick and roll if played over the native grass knoll at the start of the fairway. Weigh the risk-reward options for your approach to score on this reachable par 5.', NULL),
(2, 11, 4, 4, '00:55:00', 2, 2, 'Tee shots aimed at the oak tree on the left side of the fairway and hit with a slight fade will position your ball in the center of this long par 4. Those players not confident in their ability to reach this green in two should leave their approach out to the left of the green for the best angle in for their third.', NULL),
...
(2, 13, 4, 4, '01:05:00', 12, 14, 'Aim for the large fairway bunker found on the far side of the fairway to position your ball for the approach. Left and long of this green will bring your ball back toward the putting surface.', NULL),
(2, 14, 3, 3, '01:10:00', 16, 16, 'Confidence in your yardage and club selection is necessary for this par 3. Beware, the bunker is separated from the green and with the elevation change, players may under club.', NULL),
(2, 15, 4, 4, '01:15:00', 18, 18, 'A birdie opportunity is presented on this downhill par 4. The green is slightly crowned, so get your ball to the correct side and leave it below the hole for your best chance to score.', NULL),
(2, 16, 3, 3, '01:20:00', 14, 12, 'Draw the ball from right to left to make best use of this diagonally positioned green.', NULL),
(2, 17, 4, 4, '01:25:00', 8, 8, 'Aim your tee shot at the distant fairway bunker and turn it over from right to left to launch your ball down this wide fairway. Presented with one of the smaller greens, the player must attack the hole through the air or on the ground.', NULL),
(2, 18, 5, 5, '01:30:00', 6, 6, 'Split the two fairway bunkers from the elevated tees and you will be on your way to a good score. The small green breaks in several directions and is better suited for a wedge than a fairway wood, but well-played shots will be rewarded.', NULL),
(3, 1, 4, 4, '00:05:00', 13, 13, 'Our opening hole on the north course generally plays into the prevailing wind. Three strategically placed fairway bunkers make teeshot placement a premium allowing the player a short iron into a well guarded and undulating green.', NULL),
...
(3, 3, 3, 3, '00:15:00', 17, 17, 'This uphill holes plays slightly longer than the yardage. A back hole location can produce difficult putting conditions as a spine runsthrough that area of the green.', NULL),
(3, 4, 4, 4, '00:20:00', 5, 5, 'Accuracy off of the tee will once again be at a premium. For a clear approach to the two tiered green, the player will need to keep tothe left side of the fairway. A player making a birdie here will pick up a stroke on their opponent', NULL),
(3, 5, 5, 5, '00:25:00', 7, 3, 'Again, being accurate off of the tee will determine how the player will attack this hole. Those that find the fairway may have theopportunity to reach this par five in two. Those that dont will have to negotiate a challenging lay up as a large tree on the left hand sideof the fairway and fairway bunkers short right of the green dictate strategy.', NULL),
(3, 6, 4, 4, '00:30:00', 9, 11, 'Driver may not be the play off of the tee for everyone. Several fairway bunkers and out of bound left may produce a layup tee ball shortof any trouble. The second short normally play about a half of club more as the green is slightly uphill.', NULL),
(3, 7, 3, 3, '00:35:00', 15, 15, 'This beautiful, slightly downhill par three will play about a half of club shorter than the yardage. The difficult, undulating green will putputting at a premium. A birdie here will be a bonus for any player', NULL),
(3, 8, 4, 4, '00:40:00', 11, 9, 'The two left side fairway bunkers tighten up the driving area a bit, but there is plenty of room to the right. A good drive will leave players with a mid to short iron into the green for their second shot', NULL),
(3, 9, 4, 5, '00:45:00', 3, 7, 'Accuracy off of the tee is a premium here. Out of bounds left and bunkers and pine trees right call for a straight drive that will leave theplayers a long to mid iron into the green. In Ross fashion, the green allows for balls to be bounced on to the putting surface', NULL),
(3, 10, 4, 4, '00:50:00', 10, 10, 'A solid drive will set the player up with a mid iron approach on this dogleg left hole. Trees left and several fairway bunkers will again place a premium on proper placement of the tee shot.', NULL),
(3, 11, 3, 3, '00:55:00', 16, 16, 'Birdies are hard to come by on the longest of the four par three holes on the north. Guarded by two bunkers, this green looks relativelysimple from the tee. However, closer inspection will reveal a front bowl and several places to hide the hole location', NULL),
(3, 12, 4, 5, '01:00:00', 2, 6, 'Par is a good score on this long and difficult par four. A tee shot that avoids the trees left and a fairway bunker in the driving zone onthe right side will set the player up with a long to mid iron into the elevated green. A false front, on the left side of the green complex,will cause a approach shot coming up short to roll away.', NULL),
...
(3, 14, 5, 5, '01:10:00', 6, 4, 'Big hitters normally have a go at this green in two but the player needs to beware of the large penalty area short of the green. A layupshot can be challenging as the player will need to avoid a cross bunker on the right and the penalty are on the left. Once on the green, putting wont come easy on this large and undulating surface', NULL),
(3, 15, 3, 3, '01:15:00', 18, 18, 'Dont be short on this classic Ross designed par three that can play longer that it looks. Many shots have plugged under the front lipwhile trying to squeeze the tee shot into a front hole location. Players will normally be hitting mid to short irons into this small green that has bunkers short, left, and right', NULL),
(3, 16, 4, 4, '01:20:00', 14, 14, 'With bunkers on both sides of the driving zone, a tee shot short of these hazards will serve the player well leaving a mid iron approachto the green. One of the more under-rated putting surfaces on the course, it can frustrate those with makeable putts', NULL),
(3, 17, 5, 5, '01:25:00', 4, 2, 'Bunker placement throughout this hole requires sound strategy on the longest of the four par fives on the North. A generous opening into the green will allow balls to be run onto this undulating putting surface', NULL),
...
(4, 1, 4, 4, '00:05:00', 5, 7, 'A solid drive that avoids the two fairway bunkers will leave a mid to short iron shot into this green that slopes drastically from back tofront. An over-aggressive putt from the back of the green could lead to some frustration on this putting surface', NULL),
...
(4, 3, 3, 3, '00:15:00', 17, 17, 'The first of the South courses six par three holes. A mid to short iron approach on this straight forward hole normally plays down wind.', NULL),
(4, 4, 4, 4, '00:20:00', 11, 11, 'A left hand cross bunker on this dog leg left hole challenges the player. They must either lay up short or try and carry it. Aggressive teeshots can lead to birdie opportunities', NULL),
(4, 5, 3, 3, '00:25:00', 13, 13, 'A spine runs through this green from back to front making putting and recovery shots difficult. Bunkers short, right, and leftonly add tothe character of this hole', NULL),
(4, 6, 5, 5, '00:30:00', 3, 1, 'This reachable par five generally plays into the prevailing wind. Out of bounds left and several well placed bunkers throughout the holemay cause the player consternation.', NULL),
(4, 7, 4, 4, '00:35:00', 7, 5, 'Fairway bunkers right force the tee shot left on this medium length par four. A very large oak tree protects the left front side of this bowlshaped green.', NULL),
(4, 8, 4, 4, '00:40:00', 9, 9, 'Avoiding the fairway bunkers right and left will leave the player a mid to short iron into a green that falls off to the left. In classic Donald Ross fashion, a ball can be rolled onto the green.', NULL),
(4, 9, 3, 3, '00:45:00', 15, 15, 'Avoiding the fairway bunkers right and left will leave the player a mid to short iron into a green that falls off to the left. In classic Donald Ross fashion, a ball can be rolled onto the green.', NULL),
(4, 10, 4, 4, '00:50:00', 6, 4, 'A solid drive from an elevated tee will set the player up with a mid iron approach on this hole. Two mounds on the putting surface maymake putting an adventure.', NULL),
(4, 11, 4, 4, '00:55:00', 12, 12, 'A perfect carry over the fairway cross bunker promises a short shot to the green, but a slight miss left or right makes par a difficult score. The well bunkered green slopes from back to front testing downhill putting skills.', NULL),
(4, 12, 3, 3, '01:00:00', 18, 16, 'The penalty area to the left causes many shots to be pushed into the bunker right of the flattest green on the South.  Stretching to 179 yards, a brisk northerly wind can put a long iron or fairway wood into a players hand.', NULL),
(4, 13, 4, 4, '01:05:00', 2, 8, 'Another of our outstanding par four holes on the South.  Trees line the fairway, with a right hand bunker at the premium landing area.  The subtly contoured green makes a two putt no sure thing.', NULL),
(4, 14, 3, 3, '01:10:00', 14, 14, 'This slightly uphill par three plays to forgiving bowl shaped green and accounts for more holes-in-one that any other hole at the Club.', NULL),
(4, 15, 4, 4, '01:15:00', 10, 10, 'This may be the Clubs most underrated hole.  Looking innocent from the tee, this green has difficult hole locations on the right and left sides of this small green.  Shoot for the middle and have a reasonable chance at par. ', NULL),
(4, 16, 4, 5, '01:20:00', 4, 6, 'The last of the Souths outstanding par four holes, this slight dogleg right requires an actuate tee shot to avoided fairway bunkers right and left.  Approach shot can be run up onto this small putting surface.', NULL),
(4, 17, 3, 3, '01:25:00', 16, 18, 'Normally playing longer than its yardage, shifting winds can add to this hole being more difficult than it looks.  Balls missing left face a steep drop off making getting up and down a challenge.', NULL),
(4, 18, 5, 5, '01:30:00', 8, 2, 'One of the few holes where the golfer normally has the wind at their back. Tee shots need to get to the corner of the dog leg right in order to have a open second shot.  Longer hitters can reach the green in two but players laying up will need to avoid several strategically place fairway bunkers well short of the green.  The most severely sloped green on the South further complicates matters for the player.', NULL);
-- Tee Insert -------------------------
-- Course 1 -----------------------
